...
citizen_priv_sk_path=$(ls ../crypto-config/peerOrganizations/citizen.com/users/Admin\@citizen.com/msp/keystore/)
...
sed -i "s/priv_sk/$citizen_priv_sk_path/" ./connection-profile/citizen_network.json
